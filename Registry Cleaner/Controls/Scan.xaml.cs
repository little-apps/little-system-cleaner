...
namespace Registry_Cleaner.Controls
{
    public partial class Scan
    {
        ...
        public ObservableCollection<ScannerListViewItem> SectionsCollection { get; } =
        ...
        private void StartScanning()
        {
            ...
            finally
            {
                ...
                Utils.Watcher.EventPeriod("Registry Cleaner", "Scan", (int)ts.TotalSeconds, true);
                ...
                Dispatcher.BeginInvoke(new Action(() => Utils.TaskbarProgressState = TaskbarItemProgressState.None));
