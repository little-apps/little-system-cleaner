...
namespace Registry_Cleaner.Controls
{
    ...
    public partial class Start : INotifyPropertyChanged
    {
        ...
        public Start(Wizard sb)
        {
            ...
            ExcludeArray = new ObservableCollection<ExcludeItem>(Settings.Default.ArrayExcludeList.Cast<ExcludeItem>());
        ...
        private void UpdateSettings()
        {
            ...
            Settings.Default.ArrayExcludeList = new ObservableCollection<object>(ExcludeArray);
        }
